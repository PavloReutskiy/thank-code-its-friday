    ...
    <main className='mx-auto max-w-[85%] xxl:max-w-[1224px] mt-[89px] sm:mt-[113px] xxl:mt-[129px]'>
      <div className='text-wrapper mx-auto max-w-[800px] mb-10 md:mb-12 lg:mb-14'>
        ...
        >
          ...
          motivated developers to create a particular tool fascinates me immensely.
        </p>
      ...
      <div className='mb-10 md:mb-12 lg:mb-14'>
        ...
        <div className='stack-wrapper grid grid-cols-4 md:grid-cols-6 gap-x-5 gap-y-8
          justify-center justify-items-center'
        >
          {stack.map(technology => (
            <div key={technology.title} className='h-full w-auto flex flex-col justify-center items-center gap-3 group'>
              <Image
